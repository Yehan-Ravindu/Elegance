...
const CartSidebar: React.FC<CartSidebarProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <>
            ...
            <div className="border-t border-gray-200 p-4 bg-gray-50">
              ...
              <div className="space-y-2">
                <button 
                  ...
                  className="w-full py-3 bg-darkBrown text-white rounded hover:bg-mediumBrown transition-colors duration-300 font-body"
                >
                  Proceed to Checkout
                </button>
                <button 
      ...
      <BillSummary isOpen={isBillSummaryOpen} onClose={() => setIsBillSummaryOpen(false)} />
    </>
  );
};
